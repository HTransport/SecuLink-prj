...
namespace SecuLink.Services
{
    public class CardService : ICardService
    {
        ...
        public async Task Edit(string SerialNumber, string CurrentSerialNumber)
        {
            var a = await _dbcont.Cards.FirstOrDefaultAsync(card => card.SerialNumber == CurrentSerialNumber);
