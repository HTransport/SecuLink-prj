...
namespace SecuLink.Services
{
    public class AuthService : IAuthService
    {
        ...
        public async Task EditReader(string MAC, bool Role)
        {
            var r = await _dbcont.Readers.FirstOrDefaultAsync(e => e.MAC == MAC);
        ...
        public Task<List<ReaderListItem>> GetReaders(string MAC, bool Role)
        {
